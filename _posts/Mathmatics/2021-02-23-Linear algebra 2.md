...
## Matrix representation
  ...
  - $A = ([T]^\gamma)_\beta$는 ordered basis인 $\beta$를 LT인 T를 통해서 다른 ordered basis인 $\gamma$로 LT하겠다는 걸 나타낸다.
...
## Ex. 2
 ...
 - U*변환 시킬 차원 이라고 생각하면 U는 $\\begin{pmatrix} 0 & 1 & 0 & 0 \\\ 0 & 0 & 2 & 0 \\\ 0 & 0 & 0 & 3 \\end{pmartix}$
