...
![Alt text](https://leechanhyuk.github.io/assets/image/opengl1/opengl1.jpg)
...
![Alt text]](https://leechanhyuk.github.io/assets/image/opengl1/VBO1.png)
...
![Alt text]](https://leechanhyuk.github.io/assets/image/opengl1/VBO2.PNG)
...
![Alt text]](https://leechanhyuk.github.io/assets/image/opengl1/VB03.PNG)
...
![Alt text]](https://leechanhyuk.github.io/assets/image/opengl1/VERTEX1.PNG)
...
![Alt text]](https://leechanhyuk.github.io/assets/image/opengl1/VERTEX2.PNG)
...
![Alt text]](https://leechanhyuk.github.io/assets/image/opengl1/VERTEX3.PNG)
...
![Alt text]](https://leechanhyuk.github.io/assets/image/opengl1/FRAGMENT.PNG)
...
![Alt text]](https://leechanhyuk.github.io/assets/image/opengl1/FRAGMENT1.PNG)
...
똑같이 int형 변수를 원하는 이름으로 선언해주고, glCreateShader를 통해서 shader를 만들고
 ...
 ![Alt text]](https://leechanhyuk.github.io/assets/image/opengl1/shaderProgram1.PNG)
 ![Alt text]](https://leechanhyuk.github.io/assets/image/opengl1/shaderProgram2.PNG)
 ![Alt text]](https://leechanhyuk.github.io/assets/image/opengl1/shaderProgram3.PNG)
...
![Alt text]](https://leechanhyuk.github.io/assets/image/opengl1/VAO.PNG)
...
![Alt text]](https://leechanhyuk.github.io/assets/image/opengl1/VAO1.PNG)
...
![Alt text]](https://leechanhyuk.github.io/assets/image/opengl1/RENDERING.PNG)
...
![Alt text]](https://leechanhyuk.github.io/assets/image/opengl1/RENDERING_RESULT.PNG)
...
![Alt text]](https://leechanhyuk.github.io/assets/image/opengl1/EBO1.PNG)
...
![Alt text]](https://leechanhyuk.github.io/assets/image/opengl1/EBO2.PNG)

위 코드를 보시면, 원래는 6개이던 정점이 4개로 줄어들었고, 그 대신 indices라는 index의 배열이 추가되었습니다.

![Alt text]](https://leechanhyuk.github.io/assets/image/opengl1/EBO3.PNG)
![Alt text]](https://leechanhyuk.github.io/assets/image/opengl1/EBO4.PNG)
...
![Alt text]](https://leechanhyuk.github.io/assets/image/opengl1/EBO5.PNG)

이 EBO는 여타 vertex의 속성을 저장했을 때처럼 똑같이 VAO에 저장시킬 수 있고, 마침내 VAO는 아래와 같은 형태를 띄게 됩니다.

![Alt text]](https://leechanhyuk.github.io/assets/image/opengl1/EBO6.PNG)

랜더링 코드는 결국 아래와 같은 형태를 띄게 됩니다.

![Alt text]](https://leechanhyuk.github.io/assets/image/opengl1/EBO7.PNG)

이 코드를 통해 랜더링 한 사각형 영상은 아래와 같습니다.

![Alt text]](https://leechanhyuk.github.io/assets/image/opengl1/FINAL_EBO.PNG)
...
Link : [Source_code](https://learnopengl.com/code_viewer_gh.php?code=src/1.getting_started/2.1.hello_triangle/hello_triangle.cpp "소스코드입니다~~")
